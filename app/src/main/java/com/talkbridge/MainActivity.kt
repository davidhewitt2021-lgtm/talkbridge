...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        // --- Tuning knobs ---
        const val VAD_THRESHOLD = 0.5f        // Silero speech probability threshold
        const val MIN_SILENCE_S = 0.6f        // pause that ends an utterance
        const val MIN_SPEECH_S = 0.30f        // ignore blips shorter than this
